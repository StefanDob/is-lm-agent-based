...
## Initial Model
The Initial Model branch represents the version of the project that aims to replicate Lengnick’s original model as closely as possible. The main issue observed in this version is a persistently high unemployment rate.
